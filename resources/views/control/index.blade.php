...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm">
            ...
            <form method="POST" action="/control-panel/categories" class="space-y-4">
                ...
                <button type="submit" class="w-full py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs transition-all">{{ __("ui.register_category") }}</button>
            </form>
        </div>
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm">
            ...
            <form method="POST" action="/control-panel/projects" class="space-y-4">
                ...
                <button type="submit" class="w-full py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs transition-all">{{ __("ui.register_project") }}</button>
            </form>
        </div>
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm">
    ...
    <div class="max-w-2xl mx-auto bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-8 shadow-sm">
        ...
        <form method="POST" action="/control-panel/branding" enctype="multipart/form-data" class="space-y-6">
            ...
            <div><label class="block text-[10px] font-extrabold text-gray-500 uppercase tracking-wider mb-1.5">{{ __("ui.upload_logo") }}</label><div class="flex items-center gap-3"><label class="inline-flex items-center px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs cursor-pointer">{{ __("ui.choose_file") }}<input type="file" name="logo" class="hidden" accept=".svg,.png"></label><span class="text-xs text-gray-400">{{ __("ui.logo_hint") }}</span>@if($appLogo ?? false)<span class="text-xs text-emerald-600 font-bold">✓ Logo uploaded</span>@endif</div></div>
            ...
            <button type="submit" class="w-full py-3 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm transition-all">{{ __("ui.apply_branding") }}</button>
        </form>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm">
            ...
            <form method="POST" action="/control-panel/accounts" class="space-y-4">
                ...
                <button type="submit" class="w-full py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs transition-all">{{ __("ui.register_account") }}</button>
            </form>
