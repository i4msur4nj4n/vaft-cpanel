...
<head>
    ...
    <title>Village Agro Farm - Income & Expense Ledger</title>
            ...
            <div class="relative bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-slate-800">
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-2 mb-6 border-b border-gray-200 dark:border-slate-700">
                        <a href="/" class="pb-3 text-center text-sm font-bold text-emerald-600 border-b-2 border-emerald-600">{{ __("ui.login") }}</a>
                        <a href="/register" class="pb-3 text-center text-sm font-bold text-gray-400 hover:text-gray-600 border-b-2 border-transparent">Sign Up</a>
                    </div>
                    ...
                    <p class="text-center text-xs text-gray-500 mt-5">Don't have an account? <a href="/register" class="text-emerald-600 font-bold hover:underline">Sign Up</a></p>
                </div>
            </div>
        </div>
    </main>
